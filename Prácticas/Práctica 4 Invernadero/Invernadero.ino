...
void loop() {
  ...
  Serial.print("Suelo1: ");  Serial.print(humedadSuelo1); Serial.print(" , Suelo2: ");Serial.print(humedadSuelo2);Serial.print( " , Suelo3: ");Serial.print(humedadSuelo3);Serial.print( " , Suelo4: ");Serial.println(humedadSuelo4);
